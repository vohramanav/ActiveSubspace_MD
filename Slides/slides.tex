...
\begin{column}{0.5\textwidth}
\begin{figure}[htbp]
\includegraphics[width=0.7\textwidth]{./Figures/free_eigv}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
\begin{figure}[htbp]
\includegraphics[width=0.7\textwidth]{./Figures/free_ssp1D}
\end{figure}
\end{column}
\end{columns}
...
\begin{center}
\begin{figure}[htbp]
\includegraphics[width=0.40\textwidth]{./Figures/free_pdf_comp_SSP1D}
\end{figure}
\end{center}
...
\begin{figure}[htbp]
\includegraphics[width=0.8\textwidth]{./Figures/free_as_gsa}
\\ \vspace{2mm}
\includegraphics[width=0.8\textwidth]{./Figures/ub}
\end{figure}
