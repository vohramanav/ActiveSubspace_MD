...
presented earlier in Section~\ref{sec:method}, based on identifying an active subspace that captures the variability
...
findings based on total effect Sobol' indices~\cite{Vohra:2018b}~(see Figure~7 therein). 
...
In the following section, we implement the efficient approach that exploits active 
subspace for 
...
Herein, the parameters of calibration, $\alpha$ and $\gamma$ are considered to be independent and
