...
\begin{figure}[htbp]
 ...
 \begin{tabular}{ccc}
  ...
  &
  \includegraphics[width=0.30\textwidth]{./Figures/pdf_gamma}
  \end{tabular}
\caption{Top: Joint likelihood of ($\alpha$,$\lambda$), ($\alpha$,$\gamma$), and ($\lambda$,$\gamma$),
...
Bottom: Marginal likelihoods for $\alpha$, $\lambda$ and $\gamma$.}
\label{fig:like}
\end{center}
\end{figure}
%
